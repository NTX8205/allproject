...
<body>
    ...
    <form method="POST" action="../status/function.php?op=editres&mesid=<?php echo $mesid?>">
            ...
            <div class="input-group">
                <div class="input-group-prepand">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" name="content" cols="261" rows="6" id="borad" placeholder="輸入名稱" required><?php echo $row["resmes"] ?></textarea>
                    </div>
                </div>
            </div>
        </div>
