...
<body style="background-color:F0F0F0;">
    <div class="card mt-5">
        ...
        <div class="form p-3">
            <form method="POST" action="/allproject/Guestbook/create_comment.php">
    ...
    <div>
        ...
        <?php foreach ($statement as $row) { ?>
            ...
            <div class="card">
                ...
                <div>
                    <a href="/allproject/Guestbook/edit_comment.php?id=<?php echo $row['id'] ?>">
                        <input type="submit" value="修改" class="btn btn-dark mx-3" style="float:right">
                    </a>
                    <form method="POST" action="/allproject/Guestbook/delete_comment.php" onsubmit="return myform();">
