        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item ">
                        <input type="button" class="nav-link active link onPage text-white" onclick="javascript:location.href='coffee.php'" value="⌂夜景咖啡廳">
                    </li>
                </ul>
            </div>
        ...
        <tr>
            ...
            <th>
                ...
                <p>
                    ...
                    <iframe class="map" style="border:0" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJY463BZsdaTQR3u05rb7xdhw&key=AIzaSyBuO4vH4Uhq_SlTKbCTnv0V47wB_5x8XXo"></iframe>
        ...
        <tr>
            ...
            <th>
                ...
                <p>
                    ...
                    <iframe class="map" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJYQam-oMVaTQRd32z0Vf0wXU&key=AIzaSyBuO4vH4Uhq_SlTKbCTnv0V47wB_5x8XXo"></iframe>
        ...
        <tr>
            ...
            <th>
                ...
                <p>
                    ...
                    <iframe class="map" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJG0bARHUVaTQROmBcq-Zaksk&key=AIzaSyBuO4vH4Uhq_SlTKbCTnv0V47wB_5x8XXo"></iframe>
